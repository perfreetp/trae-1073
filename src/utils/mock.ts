...
export const mockCheckLists: CheckList[] = [
  {
    ...
    name: '商场消防安全检查表',
    items: [
      { id: 'i1', question: '消防通道是否畅通无堵塞？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i2', question: '灭火器是否在有效期内？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i3', question: '消火栓是否完好可用？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i4', question: '应急照明是否正常工作？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i5', question: '疏散指示标志是否清晰可见？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i6', question: '烟感探测器是否正常运行？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i7', question: '喷淋系统是否处于正常状态？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i8', question: '消防控制室是否有人值班？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i9', question: '值班人员是否持证上岗？', type: 'single', options: ['是', '否'], required: true },
  ...
  },
  {
    ...
    name: '酒店消防安全检查表',
    items: [
      { id: 'i11', question: '客房疏散通道是否畅通？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i12', question: '客房内是否配备防毒面具？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i13', question: '厨房燃气管道是否有泄漏？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i14', question: '厨房是否安装燃气报警器？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i15', question: '消防电梯是否正常运行？', type: 'single', options: ['是', '否'], required: true },
  ...
  },
  {
    ...
    name: '工厂消防安全检查表',
    items: [
      { id: 'i18', question: '生产车间消防通道宽度是否达标？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i19', question: '易燃易爆物品是否规范存放？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i20', question: '电气线路是否存在老化破损？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i21', question: '消防水泵是否正常运行？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i22', question: '是否有违规动火作业？', type: 'single', options: ['是', '否'], required: true },
  ...
  },
  {
    ...
    name: '学校消防安全检查表',
    items: [
      { id: 'i25', question: '教学楼疏散通道是否畅通？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i26', question: '实验室化学品是否规范存放？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i27', question: '宿舍是否有违规用电现象？', type: 'single', options: ['是', '否'], required: true },
      { id: 'i28', question: '消防演练是否定期开展？', type: 'single', options: ['是', '否'], required: true },
